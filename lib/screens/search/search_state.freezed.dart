...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? selectedFieldIndex});
}
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl({this.selectedFieldIndex});
  ...
  @override
  String toString() {
    return 'SearchState(selectedFieldIndex: $selectedFieldIndex)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, selectedFieldIndex);
...
abstract class _SearchState implements SearchState {
  const factory _SearchState({final int? selectedFieldIndex}) =
      _$SearchStateImpl;
